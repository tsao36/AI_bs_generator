...
def expand_with_ollama(
    ...
    result = send_ollama_chat(messages, model, ollama_url, timeout_seconds, num_gpu, num_predict)
    ...
    try:
        polished = send_ollama_chat(polish_messages, model, ollama_url, timeout_seconds, num_gpu, num_predict)
