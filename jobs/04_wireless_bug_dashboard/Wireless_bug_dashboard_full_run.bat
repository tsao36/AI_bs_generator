...
if exist "%SCRIPT_DIR%\task_log_dashboard.txt" del /q "%SCRIPT_DIR%\task_log_dashboard.txt"
set "PYTHON_EXE="
for %%P in (
...
set "PY_ARGS=--created-year 2025,2026 --hsd-limit 500 --hsd-owner-filter yaochien,timdaway,szchen,fang,kj,kjfang,jtsao1,yuweich1,frankfcy,brentonw,chenmatt,caizhiqi,flee5,wesleyku,bingyues,jzou6,chuchar1 --run-option 0 --db-append --no-menu"
