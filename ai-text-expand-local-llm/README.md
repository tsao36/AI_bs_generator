...
4. Optional touchpad-friendly shortcut: press **Alt + Right-click** to open the AI menu directly.
5. Optional keyboard shortcut: press **Ctrl + Alt + A** to open the AI menu at the mouse pointer.
6. Choose a length option: **2 sentences**, **5 sentences**, or **paragraph**.
7. If the selection is large, you also get shrink options: **1 sentence** or **3 sentences**.
8. The selected text is replaced with a rewritten version generated by your local model.
...
5. You can also open the AI menu directly with **Alt + Right-click**, or by pressing **Ctrl + Alt + A**.
6. Select one of the AI length options:
...
If no text is selected, **Alt + Right-click** falls back to the native browser context menu.
